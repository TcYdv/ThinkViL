...
function setup() {
  ...
  if(document.documentElement.clientWidth<=Small_size && document.documentElement.clientHeight>document.documentElement.clientWidth){
    ...
    Dom_elements = [Canvas,Question_Box,Question,Show_Answer_btn,Next_btn,Previous_btn,Hide_Qns,buttonstart,buttonpause,Zoom_IN,Zoom_OUT,fullbtn,Input,Observer,Vechile,Hide_INbtn,Output,Observer_Out,Vechile_Out,Hide_Outbtn,Vel_O_Slider,Acc_O_Slider,Input_Vel_O,Input_Acc_O,Vel_Ve_Slider, Acc_Ve_Slider, Dist_Ve_Slider, Input_Vel_Ve, Input_Acc_Ve, Input_Dist_Ve,Ve_Checkbox,Output_Vel_O, Output_Acc_O, Output_Dist_O, Output_Vel_Ve, Output_Acc_Ve, Output_Dist_Ve,Vect_Checkbox];
