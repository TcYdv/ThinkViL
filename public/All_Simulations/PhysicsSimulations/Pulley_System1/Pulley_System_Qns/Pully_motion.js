class motion{
  ...
  Input_Output_update(){
   ...
   Acc_B_Div.html("Acceleration B :"+round(abs((round(this.A_L,1)+round(this.A_R,1))/2),1)+' m/s²');
   Acc_C_Div.html("Acceleration C :"+round(abs(this.A_R),1)+' m/s²');
   Ten_1_Div.html("Tension 1 :"+round(this.T_1,1)+' N');
   Ten_2_Div.html("Tension 2 :"+2*round(this.T_1,1)+' N');                       // Tension 2 =2* Tension 1 writing because round problem
  }
