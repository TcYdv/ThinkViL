...
Input_Ouput_update(){
    ...
    //OUTPUT
    Acc_AB_Div.html("Accelaration : "+Math.round(abs(this.acc),1)+' m/s²');                 //accleration should be positive becuase - sign show the direction
    Ten_AB_Div.html("Tension : "+Math.round(this.tens,1)+' N');
}   
