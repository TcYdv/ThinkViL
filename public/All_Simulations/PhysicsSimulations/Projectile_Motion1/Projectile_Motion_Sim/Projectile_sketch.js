...
function setup() {
  ...
  if(document.documentElement.clientWidth<=Small_size && document.documentElement.clientHeight>document.documentElement.clientWidth){
    ...
    Dom_elements = [Canvas,buttonstart, buttonpause, Show_path, Show_Comp, Zoom_IN, Zoom_OUT, fullbtn, Input, CANNON, Input_Cannon_checkbox, Higt_Cannon_Slider, Input_Higt_Cannon, Vel_Cannon_Slider, Input_Vel_Cannon, Ang_Cannon_Slider, Input_Ang_Cannon, Hide_INbtn, Output, INSTANT, Output_Instant_checkbox, Output_Instant_Vel, Output_Instant_Higt, END, Output_End_checkbox, Output_Range, Output_MaxH, Hide_Outbtn];
